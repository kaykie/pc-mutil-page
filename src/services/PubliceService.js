  ...
  */
  ...
  static getToken(params) {
    ...
    if (/android/i.test(navigator.userAgent)) {
      tokenObj.token = 'Bearer ' + dsbridge.call('getToken', 'getToken');
      tokenObj.accessToken = dsbridge.call('getAccessToken', 'getAccessToken');
      params.onSuccess(tokenObj);
      return;
    }
